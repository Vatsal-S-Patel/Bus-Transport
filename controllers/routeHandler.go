...
func (c *Controller) CreateRouteHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = json.NewEncoder(w).Encode(model.OutputStruct{Code: http.StatusOK, Message: "route is created"})
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		json.NewEncoder(w).Encode(model.OutputStruct{Code: http.StatusInternalServerError, Message: err.Error()})
		return
...
func (c *Controller) GetAllRouteHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = json.NewEncoder(w).Encode(model.OutputStruct{Code: http.StatusOK, Message: "route is deleted", Data: routes})
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		json.NewEncoder(w).Encode(model.OutputStruct{Code: http.StatusInternalServerError, Message: err.Error()})
		return
...
func (c *Controller) DeleteRouteHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.WriteHeader(http.StatusOK)
	err = json.NewEncoder(w).Encode(model.OutputStruct{Code: http.StatusOK, Message: "route is deleted"})
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		json.NewEncoder(w).Encode(model.OutputStruct{Code: http.StatusInternalServerError, Message: err.Error()})
		return
